package com.cockroachlabs.infraestructure.cockroachdb;
...
public class AccountRepository {
    ...
    public void testRetryHandling() {
        if (AccountRepository.FORCE_RETRY) {
    ...
    public int insertAccount(Account account) {
        ...
        var id = account.getId().toString();
        var balance = account.getBalance().toString();

        return runSQL("INSERT INTO accounts (id, balance) VALUES (?, ?)", id, balance);
    }
}
